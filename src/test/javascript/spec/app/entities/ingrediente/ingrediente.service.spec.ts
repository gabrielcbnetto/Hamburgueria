...
describe('Service Tests', () => {
    ...
    describe('Ingrediente Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(IngredienteService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/ingredientes/' + 123);
            });
            it('should return Ingrediente', () => {

                let entity: Ingrediente;
                service.find(123).subscribe((_entity: Ingrediente) => {
                    entity = _entity;
                });
