...
describe('Service Tests', () => {
    ...
    describe('Lanche Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(LancheService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/lanches/' + 123);
            });
            it('should return Lanche', () => {

                let entity: Lanche;
                service.find(123).subscribe((_entity: Lanche) => {
                    entity = _entity;
                });
